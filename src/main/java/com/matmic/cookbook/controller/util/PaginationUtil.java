...
public final class PaginationUtil {
    ...
    private static String generateUri(String baseUrl, int page, int pageSize){
        return UriComponentsBuilder.fromUriString(baseUrl).queryParam("page", page)
                .queryParam("size", pageSize).toUriString();
    }


    public static HttpHeaders paginationHttpHeader(Page page, String baseUrl){
